...
{
    /// <inheritdoc />
    public partial class AddExcelExportDataTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoricalSpotData", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "IntradaySpotData",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    ChangePercent = table.Column<decimal>(type: "decimal(10,4)", nullable: true),
                    DataSource = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IntradaySpotData", x => x.Id);
                });
