# Simple Service Health Monitor
# Basic monitoring script for Kite Market Data Service
...
function Show-ServiceStatus {
    ...
    # Database Status
    Write-ColorOutput "DATABASE STATUS" -Color Yellow
...
function Show-QuickStatus {
    ...
    Write-ColorOutput "$ServiceName Status: $status | API: $apiStatus | DB: $dbStatusText" -Color $color
}
