-- Query to find LC/UC changes from Last Business Date (2025-10-10) to Current Business Date (2025-10-13)
...
SELECT 
    ...
    c.CurrentBusinessDate as [Current_BD],
...
-- Summary Statistics
SELECT 
    'SUMMARY: LC/UC Changes from Last Business Date (10-Oct-2025) to Current Business Date (13-Oct-2025)' as Summary;
