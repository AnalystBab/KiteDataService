# Create Working Shortcuts with Correct Target Paths
# This will create shortcuts that actually work

Write-Host "Creating Working Shortcuts with Correct Target Paths..." -ForegroundColor Green
...
# Define shortcuts with working target paths
$shortcuts = @(
    @{
...
# Create new shortcuts with working target paths
Write-Host "Creating new shortcuts with working target paths..." -ForegroundColor Green
foreach ($shortcut in $shortcuts) {
    try {
...
Write-Host ""
Write-Host "Working Shortcuts Created!" -ForegroundColor Green
Write-Host ""
...
Write-Host "   - Created new shortcuts with working target paths" -ForegroundColor Cyan
Write-Host "   - Created export folders for target paths" -ForegroundColor Cyan
Write-Host ""
